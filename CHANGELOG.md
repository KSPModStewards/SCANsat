...
- Warning: Save files cannot be downgraded to a previous ## of SCANsat after updating to ## 19.0 or higher
...
- New Features:
	...
	- Updated KSPedia entry
		- Reflects all changes made for ## 18
...
- Adds new resource types and Module Manager scanner configs for KSP Interstellar Extended ## 1.9
...
- Contract Configurator Contracts included
	- Based on a slightly modified ## of severedsolo's SCANsatLite pack
...
- Replaces or augments most aspects of the stock surface resource scanning system
	...
	- Stock resource parts adapted for SCANsat resource scanning
		...
		- M700 (clamshell) scanner used for low-resolution resource scanning; covers all resources
			- A one-time patch on updating will deactivate all resource scanners to prevent existing M700 scanners from being used as they were in ## 12
...
- Persistent scanning data storage has been altered
	- Requires a one-time, automatic con## from the old to the new method
...
* Update for KSP ## 0.23.5. This ## of SCANsat now requires KSP 0.23.5.
...
+ [dev] ## number hardcoded, now "1.0.6.0" until ## 6.1 ("1.0.6.1") or 7.0 ("1.0.7.0"). [tg]
...
- Update for KSP ## 0.23. This ## of SCANsat now requires KSP 0.23.
